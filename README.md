...
[![Latest Version on Packagist](https://img.shields.io/packagist/v/rezkonline/laravel-favicon-extractor.svg?style=flat-square)](https://packagist.org/packages/rezkonline/laravel-favicon-extractor)
[![Build Status](https://img.shields.io/travis/rezkonline/laravel-favicon-extractor/master.svg?style=flat-square)](https://travis-ci.org/rezkonline/laravel-favicon-extractor)
[![Total Downloads](https://img.shields.io/packagist/dt/rezkonline/laravel-favicon-extractor.svg?style=flat-square)](https://packagist.org/packages/rezkonline/laravel-favicon-extractor)
